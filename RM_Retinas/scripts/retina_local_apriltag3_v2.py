...
# Extract camera_params, which are focal lenghts and opticacl center each in x, y direction
# mtx = | fx  0  cx |
#       |  0 fy  cy |
#       |  0  0  1  |
...
world_tag_positions = {
    ...
    578: np.array([30, 0, 0, 1]),
    581: np.array([0, 30, 0, 1]),
    586: np.array([30, 30, 0, 1])
}
...
while True:
    ...
    result = detector.detect(gray, estimate_tag_pose= True, camera_params = camera_params, tag_size = tag_size)
