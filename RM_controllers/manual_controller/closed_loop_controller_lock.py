...
import linknetworking_lock as linknetworking # lock version

import RM_dashboard.dashboard as dashboard
import RM_Retinas.main_lock as retinas # lock version
...
class ClosedLoopController:
    ...
    #     print(retinas.retinas_data)
        ...
        if self.first_call:
            ...
            sleep(30)  # Wait for 15 seconds on the first call
